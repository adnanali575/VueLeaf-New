...
<template>
  <div class="mb-8">
    <Button class="max-sm:w-full bg-green-600 hover:bg-green-700 text-white rounded-md" @click="isOpen = true">
              ...
              <DialogPanel class="w-full max-w-[600px] bg-white rounded-lg shadow-sm p-6">
                ...
                <form class="space-y-6">
                  <div class="space-y-2">
                    ...
                    <input id="title" v-model="title" placeholder="Brief description of your feedback" required
                      class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 disabled:bg-gray-50 disabled:cursor-not-allowed" />
                  </div>

                  <div class="space-y-2">
                    <Label for="type">Type</Label>
                    <select v-model="type" required
                      class="w-full bg-white border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 appearance-none">
                  ...
                  <div class="space-y-2">
                    ...
                    <input id="description" v-model="description" placeholder="Please provide detailed information..."
                      type="textarea"
                      class="min-h-32 w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 disabled:bg-gray-50 disabled:cursor-not-allowed"
                      required />
                  </div>

                  <div class="space-y-2">
                    <Label>Screenshot (optional)</Label>
                    <FileUpload v-model="attachment" />
                  </div>
                  ...
                  <div class="flex justify-end space-x-4">
                    <Button type="button" class="rounded-md bg-red-100 hover:bg-red-200 text-red-600"
                      @click="isOpen = false">
                      Cancel
                    </Button>
                    <Button type="button" class="rounded-md bg-green-100 hover:bg-green-200 text-green-600"
                      :disabled="isSubmitting || !title || !type || !description" @click="handleSubmit">
