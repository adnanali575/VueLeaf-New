...
const handleSavePreferences = async () => {
  isSaving.value = true;
  try {
    await notificationService.updateSubscription(
      alertPreferences.value.push_enabled
    );
...
<template>
  <div class="flex-1 p-2 md:p-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 md:py-8">
      <div v-if="isLoading" class="flex flex-col justify-center items-center min-h-[400px]">
      ...
      <div v-else class="max-w-7xl mx-auto space-y-6">
          ...
          <div class="flex flex-col md:flex-row items-center gap-6">
            <div class="flex-1 text-center md:text-left">
              ...
              <p class="text-gray-600 text-sm sm:text-md md:text-lg">
                Here you can customize how you stay informed about your brand's
                presence in the cannabis community. Choose which notifications
                matter most to you, from new reviews to trend alerts, set your
                preferred frequency, and configure your time zone and quiet
                hours. Take a moment to fine-tune these settings to ensure you
                get the right information at the right time.
              </p>
            </div>
            <div class="w-full max-w-xs sm:max-w-sm md:w-48 md:h-48 flex-shrink-0 relative">
              <img :src="socialMediaImage" alt="Communication illustration" class="w-full h-full object-contain" />
            </div>
          </div>
        </div>
        ...
        <Card>
          ...
          <CardContent class="space-y-6 pt-4">
            <div class="flex sm:items-center max-sm:flex-col justify-between gap-2 flex-wrap">
              <div class="flex items-center justify-between">
                <Label html-for="push-enabled" class="me-2">Enable Push Notifications</Label>
                <Switch id="push-enabled" v-model="alertPreferences.push_enabled" :disabled="isSaving"
                  @update:model-value="handlePushToggle" />
              </div>
              <div class="flex justify-end max-sm:mt-4">
                <Button @click="handleTestNotification" :disabled="!alertPreferences.push_enabled || isSaving"
                  variant="outline" size="sm" class="max-sm:w-full">
        ...
        <Card>
          <CardHeader>
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription class="text-base text-gray-500">Choose which events warrant notifications.
                </CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent class="space-y-6 pt-4">
            <div class="flex items-center justify-between">
              ...
              <Switch id="new-reviews" v-model="alertPreferences.new_review_alerts" :disabled="isSaving" />
            </div>
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-2">
              ...
              <Switch id="negative-reviews" v-model="alertPreferences.negative_review_alerts" :disabled="isSaving" />
            </div>
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-2">
              ...
              <Switch id="response-reminders" v-model="alertPreferences.response_reminders" :disabled="isSaving" />
            </div>
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-2">
              ...
              <Switch id="positive-reviews" v-model="alertPreferences.positive_review_alerts" :disabled="isSaving" />
            </div>
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-2">
              ...
              <Switch id="review-milestones" v-model="alertPreferences.review_milestones" :disabled="isSaving" />
            </div>
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-2">
              ...
              <Switch id="trend-alerts" v-model="alertPreferences.trend_alerts" :disabled="isSaving" />
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription class="text-base text-gray-500">Set how often you'd like to receive
          ...
          <CardContent class="space-y-6 pt-4">
            <div class="space-y-2">
              ...
              <Select id="notification-frequency" v-model="alertPreferences.notification_frequency" :options="[
                { value: 'daily', label: 'Daily Summary' },
                { value: 'weekly', label: 'Weekly Summary' },
              ]" placeholder="Select frequency" :disabled="isSaving" />
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription class="text-base text-gray-500">Configure your preferred time zone and set quiet
          ...
          <CardContent class="space-y-6 pt-4">
            <div class="space-y-2">
              ...
              <Select id="timezone" v-model="alertPreferences.time_zone" :options="timeZoneOptions"
                placeholder="Select your time zone" :disabled="isSaving" />
            </div>
            <div class="space-y-2">
              ...
              <div class="flex space-x-4">
                <div class="flex-1">
                  ...
                  <Input id="quiet-start" type="time" :value="alertPreferences.quiet_hours_start || ''" @input="
                    (e: Event) =>
                    (alertPreferences.quiet_hours_start =
                      (e.target as HTMLInputElement).value || null)
                  " :disabled="isSaving" />
                </div>
                <div class="flex-1">
                  <Label html-for="quiet-end">End</Label>
                  <Input id="quiet-end" type="time" :value="alertPreferences.quiet_hours_end || ''" @input="
                    (e: Event) =>
                    (alertPreferences.quiet_hours_end =
                      (e.target as HTMLInputElement).value || null)
                  " :disabled="isSaving" />
                </div>
              </div>
        ...
        <div class="flex justify-end">
          <Button class="max-sm:w-full" @click="handleSavePreferences" :disabled="isLoading || isSaving">
