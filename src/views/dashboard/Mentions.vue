...
const platformMapping: Record<string, string[]> = {
  ...
  'thecannacabana.com': ['thecannacabana.com', 'canna cabana', 'cannacabana']
}
...
<template>
  <div class="flex-1 p-2 md:p-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 md:py-8">
      ...
      <!-- Summary Cards -->
      <div class="mb-8">
        <div class="grid grid-cols-2 grid-rows-2 sm:grid-rows-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          <!-- Total Mentions -->
          <Card
      ...
      <div class="mb-8 bg-white rounded-lg shadow-sm">
        <div class="p-6 space-y-4">
          <div class="text-center">
            ...
            <p class="text-sm sm:text-md text-gray-500 sm:text-md">
          ...
          <div
            ...
            <div>
              ...
              <p class="text-gray-600 leading-relaxed mb-4"
                v-html="processContent(mention.content, mention.keyword_term)">
              </p>
            </div>
