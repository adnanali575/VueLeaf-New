            ...
            <DialogPanel class="sm:max-w-3xl bg-white rounded-lg shadow-sm p-6">
              <div class="flex flex-col space-y-6">
                <div class="flex items-center gap-8">
                  <div class="flex-1">
                    <DialogTitle class="md:text-2xl text-lg font-bold text-green-800 mb-4">Upgrade Your Experience
                    </DialogTitle>
                    <p class="md:text-lg text-gray-600 text-md">
                      Ready to unlock more tracking power? Upgrade your plan to start monitoring more keywords and get
                      deeper insights into your brand's presence. Our premium features are just a click away! 🚀
                    </p>
                  </div>
                  <div class="flex-shrink-0 w-48 h-48 relative">
                    <img :src="upgradeImage" alt="Upgrade illustration" class="object-contain w-48 h-48" />
                  </div>
                </div>
    ...
    <CardHeader>
      <div class="flex items-center gap-3 mb-2">
        ...
        <div>
          ...
          <p class="text-sm sm:text-base text-gray-500 text-left">Enter a new keyword or phrase and select sites to
            track across platforms</p>
        </div>
      </div>
    </CardHeader>
    <CardContent>
      <div class="space-y-6">
        ...
        <template v-else>
          ...
          <div class="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-3">
            <Input placeholder="Enter keyword or phrase" v-model="newKeyword"
              class="flex-grow bg-gray-50 border-gray-200 text-gray-900 focus-visible:ring-green-500" />
            <Button @click="canAddKeyword && addKeyword()"
